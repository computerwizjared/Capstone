...
impl MiniUart {
    ...
    pub fn new() -> MiniUart {
        ...
        // set baud rate (270 = 115200)
        registers.AUX_MU_BAUD.write(270);
        // enable transmitter and receiver (bit 0 and 1)
        registers.AUX_MU_CNTL_REG.or_mask(0b11);
        // set data size to 8 bits (bit 0 and 1)
...
mod uart_io {
    ...
    impl io::Write for MiniUart {
        ...
        fn flush(&mut self) -> std::io::Result<()> {
            // not told to implement, so just return OK
            Ok(())
        }
    }
}
