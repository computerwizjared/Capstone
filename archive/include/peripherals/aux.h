...
#define AUX_BASE                (PHYSICAL_BASE + 0x00215000)    /* The start of the auxiliary register addresses */
...
#define AUX_SPI2_IO_REGa        (AUX_BASE + 0xE0)               /* SPI 1 Data */
#define AUX_SPI2_IO_REGb        (AUX_BASE + 0xE4)               /* SPI 1 Data */
#define AUX_SPI2_IO_REGc        (AUX_BASE + 0xE8)               /* SPI 1 Data */
#define AUX_SPI2_IO_REGd        (AUX_BASE + 0xEC)               /* SPI 1 Data */
#define AUX_SPI2_TXHOLD_REGa    (AUX_BASE + 0xF0)               /* SPI 1 Extended Data */
#define AUX_SPI2_TXHOLD_REGb    (AUX_BASE + 0xF4)               /* SPI 1 Extended Data */
#define AUX_SPI2_TXHOLD_REGc    (AUX_BASE + 0xF8)               /* SPI 1 Extended Data */
#define AUX_SPI2_TXHOLD_REGd    (AUX_BASE + 0xFC)               /* SPI 1 Extended Data */
